...
# installed.
TCL_PREFIX='K:/end to end 2/end\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='K:/end to end 2/end\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='K:/end to end 2/end\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IK:/end to end 2/end\Library\include'
...
TCL_PACKAGE_PATH='K:/end to end 2/end\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LK:/end to end 2/end\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='K:/end to end 2/end\Library\lib\tclstub86.lib'
